...
public class PizzeriaMakkaroniCheesePizza extends CheesePizza{
	...
	public void box() {
		...
		System.out.println("Done!");
		System.out.println("Have you noticed, that this pizza is the same as Alberto´s Calzone? We are selling this as CheesePizza! lol");
		System.out.println("Even the code was stolen!");
